...
let RepoPageComponent = class RepoPageComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let RepoTableComponent = class RepoTableComponent {
    constructor() {
...
let RepositoriesRoutingModule = class RepositoriesRoutingModule {
};
